...
p3 <- ggplot(p3_data, aes(x=year, y=sum_sold, fill = year)) +
  ...
  labs(y="Number of houses sold", title = "Comparison of number of homes sold of four regions in 2019 VS 2020")
p3
```
...
ggplot(tmp1 , aes(diff, reorder(state, diff, median)))+
  ...
  labs(x="Difference of proportion of off-market", y="States", 
       title = "Boxplot of Difference of proportion of off-market \nbetween 2019 & 2020 for each state")
```
...
#levels(tmp16$property_type) <- c("Multi-Family", "Townhouse", "Condo","Family")
...
ggplot(house2, aes(x = median_list_price, fill = Region, color = Region)) +
  geom_density(alpha = 0.5) + xlab("Median List Price") + ylab("Density") +
  scale_y_continuous(labels = scales::percent) + 
  scale_x_continuous(labels = scales::dollar) + 
  ggtitle("Median List Price By Region")
```
...
ggplot(house2, aes(x = off_market_in_two_weeks, y = avg_sale_to_list)) +
  ...
  ggtitle("Filled Density Plot of Sale to List Price vs Percent Off Market in Two Weeks") +
...
states %>%
  ...
  ggtitle("Median Sale Price vs Number of Homes Sold by State") + ylab("Homes Sold") +
